class Box4 {
	...
	public Box4 biggerBox( Box4 oldBox ) {
		width = oldBox.returnDimens()[2] * 1.25;
		height = oldBox.returnDimens()[1] * 1.25;
		length = oldBox.returnDimens()[0] * 1.25;
		return new Box4(width, height, length);
	}

	public Box4 smallerBox( Box4 oldBox) {
		width = oldBox.returnDimens()[2] * 0.75;
		height = oldBox.returnDimens()[1] * 0.75;
		length = oldBox.returnDimens()[0] * 0.75;
		return new Box4(width, height, length);
	}
